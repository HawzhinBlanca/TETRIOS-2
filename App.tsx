...
import { GameMode, GameState, VisualEffectPayload, StoryNode, AdventureLevelConfig, LevelRewards, GameStats, BoardRenderConfig } from './types';
...
// --- Visual Effect Handler (Extracted for cleaner component) ---
...
// --- Inner Game Application (Wrapped by Provider) ---
const TetriosApp = () => {
  const {
    engine,
    stats,
